...
{"q":"Mixing red and yellow makes?",
 "o":["Orange","Purple","Green","Blue"],
 "a":"Orange"},

{"q":"A repeated design is called?",
 "o":["Pattern","Pitch","Noise","Beat"],
 "a":"Pattern"},

{"q":"Clay art is called?",
 "o":["Pottery","Drawing","Music","Dance"],
 "a":"Pottery"},

{"q":"Drawing is commonly done on?",
 "o":["Paper","Glass","Stone","Metal"],
 "a":"Paper"},
...
{"q":"Players in football team?",
 "o":["11","7","5","15"],
 "a":"11"},

{"q":"Jumping over a bar?",
 "o":["High jump","Sprint","Swim","Throw"],
 "a":"High jump"},

{"q":"Throwing heavy ball?",
 "o":["Shot put","Tennis","Hockey","Cricket"],
 "a":"Shot put"},

{"q":"Exercise improves?",
 "o":["Health","Color","Noise","Rain"],
 "a":"Health"},

{"q":"Fair play means?",
 "o":["Follow rules","Cheat","Fight","Ignore"],
 "a":"Follow rules"}
...
{"q":"Acting in front of people?",
 "o":["Drama","Running","Drawing","Cooking"],
 "a":"Drama"},

{"q":"Group singing?",
 "o":["Choir","Team","Class","Band"],
 "a":"Choir"},

{"q":"Story of play?",
 "o":["Script","Recipe","Map","Song"],
 "a":"Script"},

{"q":"Where actors perform?",
 "o":["Stage","Road","River","Roof"],
 "a":"Stage"},

{"q":"Music speed is?",
 "o":["Tempo","Pitch","Shape","Pattern"],
 "a":"Tempo"}
...
def boss_battle():
    ...
    while boss["hp"] > 0 and player["hp"] > 0:
        ...
        draw_bar(50,250,boss["hp"],160)

        draw_text("XP: "+str(player["xp"]),50,320)
...
def game_over():
    ...
    while True:
        ...
        draw_text("YOU WERE DEFEATED",300,250)
